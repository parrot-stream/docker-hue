...
RUN yum install -y gcc make python-devel maven python-pip gcc-c++ cyrus-sasl* sqlite-devel libxml2-devel krb5-devel libffi-devel asciidoc ant mysql mysql-devel openldap-devel sqlite-devel openssl-devel gmp-devel libxslt-devel rsynch snappy-devel
